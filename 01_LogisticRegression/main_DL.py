...
import nn_deep_learning as nnDL
import pic2matrix

project_dir = r"Y:\Data_Science\Projects\fish_classifier\\"
file_model = r"Y:\Data_Science\Projects\fish_classifier\model_parameters"
...
#--- Building de model
DeepLearning = nnDL.NN_Deep_Learning()
num_iterations = 500
learning_rate = 0.003
print_cost = False
layers_dimensions = [X_train_set.shape[0], 3, 1]

w, b = DeepLearning.model(X_train_set, Y_train_set, layers_dimensions, learning_rate, num_iterations, print_cost)
